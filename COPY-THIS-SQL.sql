...
('Children''s Hospital Foundation', 'Supporting sick children and their families with medical care, research, and family support services.', 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=400', true, 'Annual Charity Golf Tournament - April 15, 2026'),
('Environmental Conservation Trust', 'Protecting our planet for future generations through conservation efforts, renewable energy projects, and environmental education.', 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=400', true, 'Earth Day Cleanup Drive - April 22, 2026'),
('Local Food Bank Network', 'Fighting hunger in our communities by providing nutritious meals to families in need and supporting food security programs.', 'https://images.unsplash.com/photo-1593113598332-cd288d649433?w=400', false, 'Community Food Drive - March 30, 2026'),
('Education for All Initiative', 'Providing education opportunities worldwide, building schools, training teachers, and supplying educational materials to underserved communities.', 'https://images.unsplash.com/photo-1497486751825-1233686d5d80?w=400', false, 'School Building Project - May 10, 2026'),
('Senior Care Support', 'Enhancing the quality of life for elderly community members through companionship programs, healthcare assistance, and social activities.', 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?w=400', false, 'Senior Wellness Fair - June 5, 2026');
...
-- Insert upcoming draw
INSERT INTO draws (draw_date, draw_type, winning_numbers, total_prize_pool, five_match_pool, four_match_pool, three_match_pool, is_published)
VALUES (
    CURRENT_DATE + INTERVAL '5 days',
    'random',
    ARRAY[12, 25, 33, 41, 44],
    18000.00,
    7200.00,
    6300.00,
    4500.00,
